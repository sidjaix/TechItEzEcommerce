        ...
        var catalogItemFaker = new Faker<CatalogItem>()
            .CustomInstantiator(f =>
            {
                ...
                var item = new CatalogItem(
                    baseName: name,
                    slug: f.Internet.DomainWord() + "-" + f.Random.AlphaNumeric(6),
                ...
                typeof(CatalogItem).GetProperty("ShortSummary")?.SetValue(item, f.Commerce.ProductAdjective() + " " + f.Commerce.ProductMaterial());
